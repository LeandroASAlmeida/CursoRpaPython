...
navegador.find_element_by_name("titulo").send_keys("A automação é uma coisa boa?(Leandro03)")
navegador.find_element_by_name("descripcion").send_keys("Os robôs estão cada vez mais frequentes em nossas vidas..")
navegador.find_element_by_name("creador").send_keys("Leandro Almeida")
navegador.find_element_by_css_selector('input[type="email"]').send_keys("leandroslv125@gmail.com") #aspas simples por for  aspas duiplas por dentro
